...
public class SingpassOIDCIdentityProviderTest {
  @Mock() private KeycloakSession session;
  @Mock() private SingpassOIDCIdentityProviderConfig config;
  ...
  public void setUp() {
    ...
    config = new SingpassOIDCIdentityProviderConfig(model);
  ...
  void should_success_when_validate_id_token() {
    ...
    SingpassOIDCIdentityProvider singpassOIDCIdentityProvider =
        new SingpassOIDCIdentityProvider(session, config);
    ...
    // when
    JsonWebToken token = singpassOIDCIdentityProvider.validateToken(singpassJweResponse, false);
